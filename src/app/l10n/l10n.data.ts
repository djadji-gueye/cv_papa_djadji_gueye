...
export const L10N = {
  ...
  'FR': {
    ...
    contact: {
      title: 'Coordonnées',
      general: 'Générale',
      profiles: 'Autres profils sur le Web',
      phone: 'Téléphone',
      button_open_profile: 'Ouvrir le profil',
    },
    cv_download_card: {
      title: 'Téléchargez ce CV au format PDF',
    },
    cv_item: {
      button_view_link: 'VOIR LE LIEN',
      button_view_attachment: 'VOIR LE FICHIER JOINT',
      now: 'maintenant',
    },
    education: {
      ...
      language_native: 'locuteur natif',
      language_fluent: 'couramment',
      language_advanced: 'avancé',
      language_intermediate: 'intermédiaire',
      language_elementary: 'élémentaire',
      language_beginner: 'débutant',
    },
    experience: {
    ...
    header: {
      ...
      menu_education: 'Education',
      menu_publications: 'Les publications',
      menu_projects: 'Projets',
      menu_volunteering: 'Faire du bénévolat',
      menu_contact: 'Contact',
      menu_about: 'À propos',
    },
    overview: {
      ...
      subtitle_interests: 'Les hobbies et centres d\'intérêt',
    },
    pdf: {
      button_tooltip: 'Télécharger le CV au format PDF',
      label_city: 'Ville',
      label_email: 'mail',
      continuing_next_page: 'Suite à la page suivante...',
      continued_from_last_page: '... suite de la page précédente.',
      info_generation: 'Ce CV a été généré à partir d\'un CV en ligne auto-hébergé utilisant le projet AngularCV.',
      info_headhunter: '',
    },
    projects: {
      title: 'Projects',
